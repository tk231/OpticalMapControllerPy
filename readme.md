...
| [7, 0, 0]   | LED 3 On/Off                                   |
| [9, 0, 0]   | LED 4 On/Off                                   |
| [10, 0, 0]  | Turn light pulsing on (not yet implemented)    |
| [11, 0, 0]  | LED power source on button                     |
| [12, 0, 0]  | LED power source off button                    |
| [13, 0, 0]  | stop pulsing (not yet implemented)             |
| [14, 0, 0]  | turn light triggering on (not yet implemented) |
| [15, 0, 0]  | stop triggering (not yet implemented)          |
